...
namespace YiSha.Admin.Web.Areas.ToolManage.Controllers
{
    ...
    public class CodeGeneratorController : BaseController
    {
        ...
        public async Task<IActionResult> GetBaseConfigJson(string tableName)
        {
            ...
            List<string> columnList = tDataTableField.Result.Where(p => !BaseField.BaseFieldList.Contains(p.TableColumn)).ToList()
        ...
        public async Task<IActionResult> CodePreviewJson(BaseConfigModel baseConfig)
        {
            ...
            else
            {
                ...
                string codeIndex = template.BuildIndex(baseConfig, dt);
                string codeForm = template.BuildForm(baseConfig, dt);
